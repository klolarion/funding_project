...
public interface FundingService {
    ...
    /*펀딩 시작*/
    Funding createFunding(Long memberId, Long productId, Long GroupId, int fundingCategoryCode);

    Funding createFundingApi(Long productId, Long groupId, int fundingCategoryCode);
